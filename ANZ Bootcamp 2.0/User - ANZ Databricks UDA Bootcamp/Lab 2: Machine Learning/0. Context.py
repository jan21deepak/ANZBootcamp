...
# MAGIC - [2. Model Registry & Deployment.]($./2. Model Registry & Deployment) Continuing from the previous lab, in this notebook you will learn how to take models you trained & make them available to your organisation. We will expole the concept of Model Registry, model versioning & various deployment patterns that you can use to operationalise your Machine Learning models. 
# MAGIC - [3. (OPTIONAL) Drift Management.]($./3. Drift Management) In this session we will simulate Data Drift to observe how changing data may affect our models. We will learn some basic methods of how to work with Data Drift & how you can automate it with MLFlow Model Registry & Databricks Delta. 
